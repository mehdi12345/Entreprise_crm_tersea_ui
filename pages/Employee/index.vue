      ...
      <div class="row" v-if="employees.length != 0">
        <div class="table-responsive mb-0">
          ...
          <template v-slot:cell(date_of_birth)="data">
            <div class="text-center">
              {{ data.item.date_of_birth?data.item.date_of_birth:'--' }}
            </div>
          </template>
          <template v-slot:cell(verified)="data">
            <div class="text-center">
                <div class="alert-success" v-if="data.item.verified==1" style="border-radius: 20px;">
                    Verified
                </div>
                <div class="alert-danger" v-else-if="data.item.verified==-1" style="border-radius: 20px;">
                    Not Verified
                </div>
